...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MCDownloader/MCDownloader.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SimpleAudioPlayer/SimpleAudioPlayer.framework"
