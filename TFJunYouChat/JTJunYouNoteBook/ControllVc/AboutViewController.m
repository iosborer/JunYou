...
- (void)viewDidLoad {
    ...
    introTv.attributedText = [[NSAttributedString alloc] initWithString:@" 是一款IOS私密记事APP。用户可以自由的建立分类文件夹， 对记事分类管理. 可以设置私密保护开关，为你的记事添加安全保护。P Note 你值得拥有。" attributes:attributes];
