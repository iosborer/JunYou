...
@interface TFJunYou_CommonService()
...
@implementation TFJunYou_CommonService

// 发送课程
- (void)sendCourse:(TFJunYou_MsgAndUserObject *)obj Array:(NSArray *)array {
    
    [[UIApplication sharedApplication] setIdleTimerDisabled:YES];
    g_subWindow.frame = CGRectMake(TFJunYou__SCREEN_WIDTH - 80 - 10, 50, 80, 100);
...
//    _timeIndex ++;
    TFJunYou_MessageObject *msg= _courseArray[self.sendIndex];
