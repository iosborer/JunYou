...
//遵循协议－－
@interface TFJunYou_ImageView () <UIGestureRecognizerDelegate, CAAnimationDelegate>
...
@implementation TFJunYou_ImageView
@synthesize delegate;
@synthesize didTouch;
...
-(void)setImage:(UIImage *)image{
    switch (self.animationType) {
        case TFJunYou_ImageView_Animation_More:
            [self addAnimationPage:2];
            break;
        case TFJunYou_ImageView_Animation_Line:
            [self addAnimation:TFJunYou__showImage_time];
            break;
        default:
            break;
    }
