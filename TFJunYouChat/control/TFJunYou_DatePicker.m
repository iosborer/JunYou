...
#import "TFJunYou_DatePicker.h"

@implementation TFJunYou_DatePicker
...
//        [p release];
       ...
       _sel = [[TFJunYou_Label alloc] initWithFrame:CGRectMake(h, 0, frame.size.width-h*2, h)];
...
//        [_sel release];
        ...
        TFJunYou_ImageView* iv = [[TFJunYou_ImageView alloc]initWithFrame:CGRectMake(0, 0, h, h)];
...
//        [iv release];
        ...
        iv = [[TFJunYou_ImageView alloc]initWithFrame:CGRectMake(frame.size.width-h, 0, h, h)];
