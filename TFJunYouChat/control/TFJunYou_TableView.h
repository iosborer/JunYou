...
@protocol TFJunYou_TableViewDelegate <NSObject>
@optional
...
@interface  TFJunYou_TableView : UITableView
{
    UILabel *_tipLabel;
    UIButton *_tipBtn;
@private
...
@property (nonatomic,weak) id<TFJunYou_TableViewDelegate> touchDelegate;
