                               ...
                               thisView:(UIView*)thisView
{
    ...
    TFJunYou_Label* label = [[TFJunYou_Label alloc]initWithFrame:frame1];
...
+ (UINavigationBar *)createNavigationBarWithBackgroundImage:(UIImage *)backgroundImage title:(NSString *)title {
    UINavigationBar *customNavigationBar = [[UINavigationBar alloc] initWithFrame:CGRectMake(0, 0, TFJunYou__SCREEN_WIDTH, 44)];
...
{
    TFJunYou_ConfirmView *view = [[TFJunYou_ConfirmView alloc] initWithTitle:@""
                                               message:message
                                              delegate:delegate
...
+(void)onGotoBack:(UIViewController*)vc{
    ...
    vc.view.frame = CGRectMake (TFJunYou__SCREEN_WIDTH, 0, vc.view.frame.size.width, vc.view.frame.size.height);
