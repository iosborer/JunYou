...
@implementation TFJunYou_TopMenuView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        for(i=0;i<[items count];i++){
            ...
            TFJunYou_BadgeView* p = [[TFJunYou_BadgeView alloc] initWithFrame:CGRectMake(btn.frame.size.width-16-2, 2, 16, 16)];
            p.badgeString  = nil;
