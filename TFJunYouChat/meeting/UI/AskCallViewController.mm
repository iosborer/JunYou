...
- (void) customView {
    ...
    _labelRemoteParty.frame = CGRectMake(0, 109, TFJunYou__SCREEN_WIDTH, 25);
    ...
    _animationImgV = [[UIImageView alloc] initWithFrame:CGRectMake((TFJunYou__SCREEN_WIDTH-145)/2, (TFJunYou__SCREEN_HEIGHT-145)/2-30, 145, 145)];
    ...
    _timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_animationImgV.frame) + 20, TFJunYou__SCREEN_WIDTH, 20)];
...
//    _viewTop.frame = CGRectMake(0, 40, TFJunYou__SCREEN_WIDTH, 86);
...
//    _viewBottom.frame = CGRectMake(0, TFJunYou__SCREEN_HEIGHT*3.2/5, TFJunYou__SCREEN_WIDTH, TFJunYou__SCREEN_HEIGHT/2);
...
//    [self.tableBody addSubview:_viewBottom];
    ...
    _buttonHangup.frame = CGRectMake((TFJunYou__SCREEN_WIDTH - Button_Width) / 2 , CGRectGetMaxY(_timeLabel.frame)+(TFJunYou__SCREEN_HEIGHT-CGRectGetMaxY(_timeLabel.frame)-Button_Height)/2-20, Button_Width, Button_Height);
