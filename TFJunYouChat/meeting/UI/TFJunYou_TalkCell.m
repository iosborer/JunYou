...
@implementation TFJunYou_TalkCell
...
//    _lastTime = [[UILabel alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH - 100, 10, 100, 20)];
...
//
//    _talkTime = [[UILabel alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH - 100, CGRectGetMaxY(_lastTime.frame), 100, 20)];
...
//
//    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 60 - .5, TFJunYou__SCREEN_WIDTH, .5)];
//    line.backgroundColor = [UIColor colorWithRed:0.8 green:0.8 blue:0.8 alpha:1];
//    [self addSubview:line];
}

- (void)setTalkModel:(TFJunYou_TalkModel *)talkModel {
    _talkModel = talkModel;
    
    [g_server getHeadImageSmall:talkModel.userId userName:talkModel.userName imageView:_headImage];
