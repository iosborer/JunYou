...
-(void)customUI{
    ...
    _loginStateLabel = [UIFactory createLabelWith:CGRectMake(TFJunYou__SCREEN_WIDTH-60-10, 10, 60, 20) text:Localized(@"JXAudioMeeting_NotLogin") font:g_factory.font13 textColor:[UIColor blackColor] backgroundColor:nil];
    _loginStateLabel.textAlignment = NSTextAlignmentCenter;
    
    [self.tableBody addSubview:_loginStateLabel];
    
    
    _noticeLabel = [UIFactory createLabelWith:CGRectMake(25, CGRectGetMaxY(_loginStateLabel.frame)+15, TFJunYou__SCREEN_WIDTH-25*2, 60) text:@"" font:g_factory.font16 textColor:[UIColor blackColor] backgroundColor:nil];
    ...
    if (_type == AudioMeetingTypeNumberByUserSelf) {
        ...
        _phoneTextF = [UIFactory createTextFieldWithRect:CGRectMake((TFJunYou__SCREEN_WIDTH-100)/2, CGRectGetMaxY(_noticeLabel.frame)+15, 100, 30) keyboardType:UIKeyboardTypePhonePad secure:NO placeholder:@"****" font:g_factory.font14 color:[UIColor blackColor] delegate:self];
    }else if (_type == AudioMeetingTypeGroupCall) {
        _noticeLabel.text = Localized(@"JXAudioMeeting_StartGroupCallNotice");
        _phoneTextF = [UIFactory createTextFieldWithRect:CGRectMake((TFJunYou__SCREEN_WIDTH-150)/2, CGRectGetMaxY(_noticeLabel.frame)+15, 150, 30) keyboardType:UIKeyboardTypePhonePad secure:NO placeholder:nil font:g_factory.font14 color:[UIColor blackColor] delegate:self];
    ...
    _starMeetBtn = [UIFactory createButtonWithRect:CGRectMake(25, CGRectGetMaxY(_phoneTextF.frame) +50, TFJunYou__SCREEN_WIDTH-25*2, 40) title:Localized(@"JXAudioMeetingVC_StartMeeting") titleFont:g_factory.font16 titleColor:[UIColor whiteColor] normal:nil selected:nil selector:@selector(startMeeting) target:self];
    _starMeetBtn.backgroundColor = THEMECOLOR;
