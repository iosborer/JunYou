...
@interface TFJunYou_OpenRedPacketVC ()
@end
@implementation TFJunYou_OpenRedPacketVC
- (instancetype)init
{
    self = [super init];
    if (self) {
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    _packetListArray = [TFJunYou_GetPacketList getPackList:_dataDict];
    [self setViewSize];
    [self setViewData];
}
-(void)setViewSize{
...
-(void)setViewData{
    ...
    for (TFJunYou_GetPacketList * listObj in _packetListArray) {
