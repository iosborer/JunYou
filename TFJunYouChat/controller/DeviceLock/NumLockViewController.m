...
//    self.view.backgroundColor = [UIColor colorWithRed:0.8 green:0.5 blue:0.2 alpha:1.0];
    ...
    [self initSmallDrop];
    _hintLa = [[UILabel alloc] initWithFrame:CGRectMake(0, (__MainScreen_Height - 218)/2 - 80, TFJunYou__SCREEN_WIDTH, 23)];
    ...
    [deleteBu setFrame:CGRectMake(TFJunYou__SCREEN_WIDTH - 100, __MainScreen_Height - 100, 80, 20)];
    ...
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, TFJunYou__SCREEN_TOP - 46, 46, 46)];
...
- (void)initNumLockKeyboard
{
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        if (i == 0)
        {
            ...
            [numBu setFrame:CGRectMake((TFJunYou__SCREEN_WIDTH - 64) / 2, (__MainScreen_Height - 218)/2 + 228, 64, 64)];
        }
        else
        {
            ...
            CGFloat x = 0;
            if ((i - 1) % 3 == 0) {
                x = (TFJunYou__SCREEN_WIDTH - 272) / 2;
            }else {
                x = (i-1)%3*104 + ((TFJunYou__SCREEN_WIDTH - 272) / 2);
            }
...
- (void)initSmallDrop
{
    _dropV = [[UIView alloc]initWithFrame:CGRectMake((TFJunYou__SCREEN_WIDTH - 160) / 2, (__MainScreen_Height - 218)/2 - 40, 160, 12)];
