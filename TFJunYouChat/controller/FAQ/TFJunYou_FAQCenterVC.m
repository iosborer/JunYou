...
- (void)viewDidLoad {
    ...
    TFJunYou_ImageView *iv = [self createButton:@"book号设置" icon:@"icon_question" drawTop:NO drawBottom:YES must:NO click:@selector(action1:) superView:self.tableBody];
    ...
    iv = [self createButton:@"book群聊" icon:@"icon_question" drawTop:NO drawBottom:YES must:NO click:@selector(action4:) superView:self.tableBody];
    iv.frame = CGRectMake(0,y, TFJunYou__SCREEN_WIDTH, HEIGHT);
    y += iv.frame.size.height;
    
    iv = [self createButton:@"book" icon:@"icon_question" drawTop:NO drawBottom:YES must:NO click:@selector(action5:) superView:self.tableBody];
    iv.frame = CGRectMake(0,y, TFJunYou__SCREEN_WIDTH, HEIGHT);
    y += iv.frame.size.height;
    
    iv = [self createButton:@"book支付" icon:@"icon_question" drawTop:NO drawBottom:YES must:NO click:@selector(action6:) superView:self.tableBody];
    iv.frame = CGRectMake(0,y, TFJunYou__SCREEN_WIDTH, HEIGHT);
    y += iv.frame.size.height;
