...
@implementation TFJunYou_MenuView
...
//    }];
    self.frame = CGRectMake(TFJunYou__SCREEN_WIDTH-44, frame.origin.y, 0, HEIGHT);
    [UIView animateWithDuration:.1f animations:^{
        self.frame = CGRectMake(TFJunYou__SCREEN_WIDTH-_w-44, frame.origin.y, w, HEIGHT);
    }];
