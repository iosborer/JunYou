//
//  TFJunYou_AnnounceViewController.m
//  TFJunYouChat
//
...
#import "searchData.h"
#import "TFJunYou_AnnounceCell.h"

#define HEIGHT 54
#define STARTTIME_TAG 1
#define IMGSIZE 100

@interface TFJunYou_AnnounceViewController ()<UITextViewDelegate>
...
@property (nonatomic, strong) TFJunYou_Label* relLabel;

@end

@implementation TFJunYou_AnnounceViewController
...
- (id)init
{
    ...
    if (self) {
        ...
        self.baseView = [[UIView alloc] initWithFrame:CGRectMake(40, TFJunYou__SCREEN_HEIGHT/4-.5, TFJunYou__SCREEN_WIDTH-80, 162)];
...
//        CGSize size = [self.name sizeThatFits:constraintSize];
        ...
        self.relLabel.frame =  CGRectMake(TFJunYou__SCREEN_WIDTH -32-15, TFJunYou__SCREEN_TOP-30, 32, 15);
    }
    return self;
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGSize size = [dict[@"text"] boundingRectWithSize:CGSizeMake(TFJunYou__SCREEN_WIDTH-INSETS*2-15*2, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:g_factory.font16} context:nil].size;
    
    return 116 + size.height;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *identifier = @"TFJunYou_AnnounceCell";
    TFJunYou_AnnounceCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        cell = [[TFJunYou_AnnounceCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
...
-(UITextView*)createTextField:(UIView*)parent default:(NSString*)s hint:(NSString*)hint{
    UITextView* p = [[UITextView alloc] initWithFrame:CGRectMake(0,INSETS,TFJunYou__SCREEN_WIDTH,HEIGHT)];
    p.delegate = self;
...
-(TFJunYou_Label*)createLabel:(UIView*)parent default:(NSString*)s selector:(SEL)selector{
    TFJunYou_Label* p = [[TFJunYou_Label alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH/2,INSETS,TFJunYou__SCREEN_WIDTH/2 -20,HEIGHT-INSETS*2)];
...
- (void)resetBigView {
    ...
    self.baseView.frame = CGRectMake(40, TFJunYou__SCREEN_HEIGHT/4-.5, TFJunYou__SCREEN_WIDTH-80, 162);
