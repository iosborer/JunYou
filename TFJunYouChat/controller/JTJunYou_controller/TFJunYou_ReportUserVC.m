...
@interface TFJunYou_ReportUserVC ()<UITextViewDelegate, UIAlertViewDelegate>
...
@implementation TFJunYou_ReportUserVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        UIImageView* iv;
        iv = [[UIImageView alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH-15-7, (50-13)/2, 7, 13)];
        iv.image = [UIImage imageNamed:@"new_icon_>"];
        [cell.contentView addSubview:iv];
        
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(15, 49.5, TFJunYou__SCREEN_WIDTH, LINE_WH)];
        line.backgroundColor = THE_LINE_COLOR;
        [cell.contentView addSubview:line];
        
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(15, 25-8, TFJunYou__SCREEN_WIDTH-15, 16)];
        label.tag = 100;
