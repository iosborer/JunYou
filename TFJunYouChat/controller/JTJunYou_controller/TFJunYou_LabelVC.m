...
#define HEIGHT 60
@interface TFJunYou_LabelVC ()
@property (nonatomic, strong) NSMutableArray *array;
@property (nonatomic, strong) UIView *emptyView;
@property (nonatomic, strong) TFJunYou_LabelObject *currentLabelObj;

@property (nonatomic, strong) QBPopupMenu *popupMenu;
@end

@implementation TFJunYou_LabelVC
...
- (void)customView {
    ...
    for (int i = 0; i < _array.count+1; i++) {
        ...
        NSString *title;
        if (i < _array.count) {
            TFJunYou_LabelObject *label = _array[i];
...
//    UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, TFJunYou__SCREEN_WIDTH, HEIGHT)];
...
//
//    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, HEIGHT - .5, TFJunYou__SCREEN_WIDTH, .5)];
...
- (UIView *)emptyView {
    if (!_emptyView) {
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 200, TFJunYou__SCREEN_WIDTH, 20)];
        label.font = [UIFont systemFontOfSize:16.0];
        ...
        label = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(label.frame) + 10, TFJunYou__SCREEN_WIDTH, 20)];
        ...
        UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(20, CGRectGetMaxY(label.frame) + 150, TFJunYou__SCREEN_WIDTH - 40, 50)];
...
//
//    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, HEIGHT - .5, TFJunYou__SCREEN_WIDTH, .5)];
...
//        TFJunYou_LabelObject *labelObj = _array[indexPath.row];
...
- (void)onDidLabel:(UIButton *)button {
    if (button.tag == _array.count) {
        ...
        TFJunYou_LabelObject *label = _array[button.tag];
        TFJunYou_NewLabelVC *vc = [[TFJunYou_NewLabelVC alloc] init];
        vc.title = Localized(@"JX_SettingLabel");
        vc.labelObj = label;
        [g_navigation pushViewController:vc animated:YES];
