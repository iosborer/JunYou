...
@interface TFJunYou_SetChatTextFontVC ()
@property (nonatomic, strong) NSMutableArray *array;
@property (nonatomic, strong) UISlider *slider;
@property (nonatomic, assign) CGFloat oldFont;
@end

@implementation TFJunYou_SetChatTextFontVC
...
- (void)viewDidLoad {
    ...
    TFJunYou_Label *done = [[TFJunYou_Label alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH -32-15, TFJunYou__SCREEN_TOP - 15-15, 32, 15)];
    done.delegate = self;
...
- (void)done:(TFJunYou_Label *)label {
    self.oldFont = g_constant.chatFont;
...
- (void)getData {
    ...
    TFJunYou_MessageObject *msg2 = [[TFJunYou_MessageObject alloc] init];
