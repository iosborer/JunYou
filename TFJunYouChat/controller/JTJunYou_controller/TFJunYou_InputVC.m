...
@implementation TFJunYou_InputVC
...
//        self.parent.alpha = 0.5;
        ...
        UIView* iv = [[UIView alloc] initWithFrame:CGRectMake((TFJunYou__SCREEN_WIDTH-INPUT_WIDTH)/2, self.view.center.y - 80, INPUT_WIDTH, 110)];
...
//        }
        ...
        UIView* line = [[UIView alloc]initWithFrame:CGRectMake(0,CGRectGetMaxY(_value.frame) + 10,TFJunYou__SCREEN_WIDTH,LINE_WH)];
...
-(TFJunYou_Label*)createLabel:(UIView*)parent default:(NSString*)s{
    TFJunYou_Label* p = [[TFJunYou_Label alloc] initWithFrame:CGRectMake(0,0,INPUT_WIDTH,40)];
...
-(void)dealloc{
    NSLog(@"TFJunYou_InputVC.dealloc");
//    [super dealloc];
}
