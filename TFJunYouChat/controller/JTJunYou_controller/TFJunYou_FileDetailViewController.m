//
//  TFJunYou_FileDetailViewController.m
//  TFJunYouChat
//
...
@interface TFJunYou_FileDetailViewController ()<UITextViewDelegate>
...
@implementation TFJunYou_FileDetailViewController
...
-(void)customView{
    ...
    if(!_fileTitleLabel){
        ...
        _fileTitleLabel.frame = CGRectMake(15, CGRectGetMaxY(_typeView.frame)+15, TFJunYou__SCREEN_WIDTH - 30, 25);
