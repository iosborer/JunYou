//
//  TFJunYou_DeviceAuthController.m
//  TFJunYouChat
//
//  Created by lifengye on 2020/8/21.
//  Copyright © 2019 zengwOS. All rights reserved.
//

#import "TFJunYou_DeviceAuthController.h"
#define TFJunYou__SCREEN_BAR (THE_DEVICE_HAVE_HEAD ? 34 : 0)
@interface TFJunYou_DeviceAuthController ()
...
@implementation TFJunYou_DeviceAuthController

- (instancetype)initWithMsg:(TFJunYou_MessageObject *)msg{
    self = [super init];
    if (self) {
        self.msg = msg;
    }
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    [UIView animateWithDuration:0.5 animations:^{
        ...
        self.baseView.frame = CGRectMake(0, TFJunYou__SCREEN_BAR, TFJunYou__SCREEN_WIDTH, TFJunYou__SCREEN_HEIGHT-TFJunYou__SCREEN_BAR);
    }];
}
...
- (void)creatView{
    self.baseView = [[UIView alloc] initWithFrame:CGRectMake(0, TFJunYou__SCREEN_HEIGHT+TFJunYou__SCREEN_BAR, TFJunYou__SCREEN_WIDTH, TFJunYou__SCREEN_HEIGHT-TFJunYou__SCREEN_BAR)];
    ...
    imgV.center = CGPointMake(TFJunYou__SCREEN_WIDTH/2, 124 + 87/2);
    [self.baseView addSubview:imgV];
    
    UILabel *lab = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(imgV.frame) + 10, TFJunYou__SCREEN_WIDTH, 40)];
    ...
    lineView.frame = CGRectMake(35, CGRectGetMaxY(lab.frame) + 40, TFJunYou__SCREEN_WIDTH - 35*2, 0.3);
    ...
    UIImageView *headImgV = [[UIImageView alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH - 62 - 50, CGRectGetMaxY(lineView.frame) + 37, 50, 50)];
    headImgV.clipsToBounds = YES;
    headImgV.layer.cornerRadius = 25;
    [g_server getHeadImageLarge:MY_USER_ID userName:MY_USER_NAME imageView:headImgV];
    ...
    btn.frame = CGRectMake(15, CGRectGetMaxY(headImgV.frame) + 35, TFJunYou__SCREEN_WIDTH - 15*2, 40);
    ...
    btn2.frame = CGRectMake(15, CGRectGetMaxY(btn.frame) + 30, TFJunYou__SCREEN_WIDTH - 15*2, 40);
...
- (void)dismissViewController {
    [UIView animateWithDuration:0.5 animations:^{
        self.baseView.frame = CGRectMake(0, TFJunYou__SCREEN_HEIGHT+TFJunYou__SCREEN_BAR, TFJunYou__SCREEN_WIDTH, TFJunYou__SCREEN_HEIGHT);
