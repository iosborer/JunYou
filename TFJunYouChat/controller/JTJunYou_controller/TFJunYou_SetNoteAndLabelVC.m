...
@interface TFJunYou_SetNoteAndLabelVC () <UIScrollViewDelegate,UITextViewDelegate,UITextFieldDelegate>
...
@implementation TFJunYou_SetNoteAndLabelVC
...
- (void)customView {
    ...
    _name = [[UITextField alloc] initWithFrame:CGRectMake(15,CGRectGetMaxY(nameLab.frame)+INSETS,TFJunYou__SCREEN_WIDTH-30,40)];
    ...
    UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(_labT.frame)+INSETS, TFJunYou__SCREEN_WIDTH-30, 40)];
    ...
    _labContLab = [[UILabel alloc] initWithFrame:CGRectMake(16, 0, TFJunYou__SCREEN_WIDTH-INSETS-41, 40)];
...
//    [_labContLab addGestureRecognizer:tap];
    ...
    _baseView = [[UIView alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(deatilLab.frame)+INSETS, TFJunYou__SCREEN_WIDTH-30, 40)];
...
- (void)onLabel {
    TFJunYou_SetLabelVC *vc = [[TFJunYou_SetLabelVC alloc] init];
...
- (void)refreshLabel:(TFJunYou_SetLabelVC *)vc {
    [self getLab];
...
- (void)textViewDidChange:(UITextView *)textView {
    ...
    CGSize constraintSize = CGSizeMake(TFJunYou__SCREEN_WIDTH-14, MAXFLOAT);
