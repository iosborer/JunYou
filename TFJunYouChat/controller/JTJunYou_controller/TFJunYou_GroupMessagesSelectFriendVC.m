//
//  TFJunYou_GroupMessagesSelectFriendVC.m
//  TFJunYouChat
//
...
@interface TFJunYou_GroupMessagesSelectFriendVC () <UITextFieldDelegate, TFJunYou_SelectLabelsVCDelegate, TFJunYou_SelectGroupSendVCDelegate, OrganizeSelectVCDelegate>
...
@implementation TFJunYou_GroupMessagesSelectFriendVC
...
- (void)viewDidLoad {
    ...
    allSelect.frame = CGRectMake(TFJunYou__SCREEN_WIDTH - 60, TFJunYou__SCREEN_TOP - 33, 60, 24);
    ...
    //搜索输入框
    _tableHeadView = [[UIView alloc] initWithFrame:CGRectMake(0, TFJunYou__SCREEN_TOP, TFJunYou__SCREEN_WIDTH, 55)];
...
//    [backView addSubview:cancelBtn];
    ...
    //选择标签群发
    UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_seekTextField.frame)+8, TFJunYou__SCREEN_WIDTH, 54)];
    ...
    lineView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(btn.frame) + 4.5, TFJunYou__SCREEN_WIDTH, .5)];
    lineView.backgroundColor = HEXCOLOR(0xdcdcdc);
    [_tableHeadView addSubview:lineView];
    //选择群组群发
    UIButton *btn2 = [[UIButton alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(lineView.frame), TFJunYou__SCREEN_WIDTH, 54)];
    ...
    lineView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(btn2.frame) + 4.5, TFJunYou__SCREEN_WIDTH, .5)];
    lineView.backgroundColor = HEXCOLOR(0xdcdcdc);
    [_tableHeadView addSubview:lineView];
    //选择同事群发
    UIButton *btn3 = [[UIButton alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(lineView.frame), TFJunYou__SCREEN_WIDTH, 54)];
    ...
    lineView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(btn3.frame) + 4.5, TFJunYou__SCREEN_WIDTH, .5)];
    lineView.backgroundColor = HEXCOLOR(0xdcdcdc);
    [_tableHeadView addSubview:lineView];
    
    //选择通讯录群发
    UIButton *btn4 = [[UIButton alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(lineView.frame), TFJunYou__SCREEN_WIDTH, 54)];
    ...
    _tableHeadView.frame = CGRectMake(_tableHeadView.frame.origin.x, _tableHeadView.frame.origin.y, _tableHeadView.frame.size.width, CGRectGetMaxY(btn4.frame));
...
- (void)selectLabels:(UIButton *)btn {
    ...
    TFJunYou_SelectLabelsVC *vc = [[TFJunYou_SelectLabelsVC alloc] init];
    vc.delegate = self;
...
- (void)selectorGroup:(UIButton *)btn{
    TFJunYou_SelectGroupSendVC *vc = [[TFJunYou_SelectGroupSendVC alloc] initWithTitle:SELECTGroup];
    vc.delegate = self;
...
- (void)selectorMaillist:(UIButton *)btn{
    TFJunYou_SelectGroupSendVC *vc = [[TFJunYou_SelectGroupSendVC alloc] initWithTitle:SELECTMaillist];
    vc.delegate = self;
...
- (void)nextBtnAction:(UIButton *)btn {
    ...
    for (NSInteger i = 0; i < self.selLabelsArr.count; i ++) {
        TFJunYou_LabelObject *labelObj = self.selLabelsArr[i];
        ...
        for (NSInteger j = 0; j < labelUserIds.count; j ++) {
            ...
            NSString *labelUserName = [TFJunYou_UserObject getUserNameWithUserId:labelUserId];
            BOOL flag = NO;
    ...
    for (NSInteger i = 0; i < self.selGroupsArr.count; i++) {
        TFJunYou_UserObject *group = self.selGroupsArr[i];
    ...
    for (NSInteger i = 0; i < self.selMailistArr.count; i++) {
        TFJunYou_UserObject *user = self.selMailistArr[i];
    ...
    TFJunYou_ChatViewController *vc = [[TFJunYou_ChatViewController alloc] init];
...
//    }
    ...
    TFJunYou_UserObject *user=tempArray[indexPath.row];
