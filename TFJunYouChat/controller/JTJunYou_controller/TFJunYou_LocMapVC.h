...
//  TFJunYouChat
//
//  Created by lifengye on 2020/09/19.
//  Copyright © 2020 zengwOS. All rights reserved.
//

#import <UIKit/UIKit.h>
@class TFJunYou_LocPerImageVC;
@interface TFJunYou_LocMapVC : UIViewController<UIScrollViewDelegate>{
    ATMHud * _wait;
}
...
@property (nonatomic,strong) TFJunYou_LocPerImageVC * lastAnnotationView;//上次被选择的大头针
