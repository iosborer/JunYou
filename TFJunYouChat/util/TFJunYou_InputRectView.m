#import "TFJunYou_InputRectView.h"
#define RECT_INSET 24
@interface TFJunYou_InputRectView () <UITextViewDelegate>
...
@end
@implementation TFJunYou_InputRectView
...
- (void)setViewFrameWithSize:(CGFloat)height; {
    ...
    self.baseView.frame = CGRectMake(40, TFJunYou__SCREEN_HEIGHT/4+35-self.replayTextView.frame.size.height, TFJunYou__SCREEN_WIDTH-80, CGRectGetMaxY(self.topView.frame));
}
- (void)textViewDidChange:(UITextView *)textView {
    ...
    self.baseView.frame = CGRectMake(40, TFJunYou__SCREEN_HEIGHT/4+35-size.height, TFJunYou__SCREEN_WIDTH-80, CGRectGetMaxY(self.topView.frame));
}
- (NSString *)text {
