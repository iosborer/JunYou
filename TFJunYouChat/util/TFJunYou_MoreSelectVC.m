...
@interface TFJunYou_MoreSelectVC () <UITableViewDelegate, UITableViewDataSource>
...
@end
@implementation TFJunYou_MoreSelectVC
...
- (void)viewDidLoad {
    ...
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(40, (TFJunYou__SCREEN_HEIGHT-height)/2, TFJunYou__SCREEN_WIDTH-40*2, height)];
    ...
    UILabel *title = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, TFJunYou__SCREEN_WIDTH, 44)];
    title.text = self.titleStr;
    title.textAlignment = NSTextAlignmentCenter;
    self.tableView.tableHeaderView = title;
    UIButton *sureBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, TFJunYou__SCREEN_WIDTH, 44)];
