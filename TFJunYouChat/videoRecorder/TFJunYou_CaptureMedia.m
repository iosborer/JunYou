...
@implementation TFJunYou_CaptureMedia
...
- (id)init {
    NSLog(@"TFJunYou_CaptureMedia.init");
    self = [super init];
    if (self) {
...
- (void)dealloc {
    NSLog(@"TFJunYou_CaptureMedia.dealloc");
//	[_capSession release];
...
//    _prevLayer.frame = CGRectMake(0, (TFJunYou__SCREEN_HEIGHT-TFJunYou__SCREEN_WIDTH)/2, TFJunYou__SCREEN_WIDTH, TFJunYou__SCREEN_WIDTH);
    _prevLayer.frame = CGRectMake(0, 0, TFJunYou__SCREEN_WIDTH, TFJunYou__SCREEN_HEIGHT);
