...
@property (nonatomic, strong) TFJunYou_CollectionView * collectionView;
...
-(void)customView{
    ...
    _collectionView = [[TFJunYou_CollectionView alloc] initWithFrame:CGRectMake(0, 0, self.tableBody.frame.size.width, self.tableBody.frame.size.height) collectionViewLayout:layout];
//    [layout release];
...
//    [_collectionView release];
    ...
    submitButton.frame = CGRectMake((TFJunYou__SCREEN_WIDTH-130)/2, TFJunYou__SCREEN_HEIGHT+(TFJunYou__SCREEN_BOTTOM-38)/2-TFJunYou__SCREEN_BOTTOM, 130, 38);
...
{
    return CGSizeMake((TFJunYou__SCREEN_WIDTH - 30)/2, (TFJunYou__SCREEN_WIDTH - 30)/2);
}
...
//    [tap release];
    ...
    [UIView animateWithDuration:0.3 animations:^{
        zoomView.frame = CGRectMake(0, 0, TFJunYou__SCREEN_WIDTH, TFJunYou__SCREEN_HEIGHT);
    }];
}
