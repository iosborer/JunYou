...
#import "TFJunYou_ConvertMedia.h"
#import "TFJunYou_CaptureMedia.h"
...
//    [preview release];
    ...
    _bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, TFJunYou__SCREEN_HEIGHT-(TFJunYou__SCREEN_HEIGHT-TFJunYou__SCREEN_WIDTH)/2, TFJunYou__SCREEN_WIDTH, (TFJunYou__SCREEN_HEIGHT-TFJunYou__SCREEN_WIDTH)/2)];
...
//    [_bottomView release];
    ...
    _recrod.frame = CGRectMake((TFJunYou__SCREEN_WIDTH-btnW)/2, 10, btnW, btnW);
...
//    [_recordLabel release];
    ...
    _close = [[TFJunYou_ImageView alloc]initWithFrame:CGRectMake(52, _recrod.frame.origin.y, 31, 31)];
...
//    [_close release];
    ...
    _save = [[TFJunYou_ImageView alloc]initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH-_close.frame.origin.x-_close.frame.size.width, _close.frame.origin.y, 31, 31)];
...
//    [_save release];
    ...
    _flash = [[TFJunYou_ImageView alloc]initWithFrame:CGRectMake(16, 10, 30, 30)];
...
//    [_flash release];
    ...
    _flashOn = [[TFJunYou_ImageView alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_flash.frame)+20, CGRectGetMinY(_flash.frame), 30, 30)];
...
//    [_flashOn release];
    ...
    _flashOff = [[TFJunYou_ImageView alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_flashOn.frame)+20, CGRectGetMinY(_flash.frame), 30, 30)];
...
//    [_flashOff release];
    ...
    _cammer = [[TFJunYou_ImageView alloc]initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH-16-30, CGRectGetMinY(_flash.frame), 30, 27)];
...
- (void)initCapture{
    _capture = [[TFJunYou_CaptureMedia alloc]init];
//    _capture.logoImage = [UIImage imageNamed:@"logo"];
    _capture.logoRect  = CGRectMake(0, TFJunYou__SCREEN_WIDTH-100, 100, 100);
    ...
    _capture.videoWidth = TFJunYou__SCREEN_HEIGHT;
    _capture.videoHeight = TFJunYou__SCREEN_WIDTH;
    _capture.outputFileName = [TFJunYou_FileInfo getUUIDFileName:@"mp4"];
