...
@implementation TFJunYou_RoomRemind
@synthesize userId,objectId,time,type,roomId,fromUserName;

static TFJunYou_RoomRemind *shared;
...
-(void)dealloc{
//    NSLog(@"TFJunYou_RoomRemind.dealloc");
    self.userId = nil;
    self.fromUserName = nil;
    self.objectId = nil;
    self.time  = nil;
...
/*
 //+(TFJunYou_RoomRemind*)sharedInstance{
 //    static dispatch_once_t onceToken;
 //    dispatch_once(&onceToken, ^{
 //        shared=[[TFJunYou_RoomRemind alloc] init];
 //    });
 //    return shared;
 //}
...
-(void)fromDataset:(TFJunYou_RoomRemind*)obj rs:(FMResultSet*)rs{
...
-(void)fromDictionary:(TFJunYou_RoomRemind*)obj dict:(NSDictionary*)aDic
{
