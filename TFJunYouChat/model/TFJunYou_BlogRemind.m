...
@implementation TFJunYou_BlogRemind

static TFJunYou_BlogRemind *shared;

+(TFJunYou_BlogRemind*)sharedInstance{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        shared=[[TFJunYou_BlogRemind alloc] init];
    });
    return shared;
}
...
-(NSMutableArray*)doFetch
{
    ...
    while ([rs next]) {
        TFJunYou_BlogRemind *obj=[[TFJunYou_BlogRemind alloc] init];
