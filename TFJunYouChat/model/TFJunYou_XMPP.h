...
@class TFJunYou_MessageObject;
@class TFJunYou_RoomPool;
@class XMPPMessage,XMPPRoster,XMPPRosterCoreDataStorage,FMDatabase,TFJunYou_emojiViewController;

@interface TFJunYou_XMPP : NSObject <UIApplicationDelegate>
...
@property (strong, nonatomic) TFJunYou_RoomPool* roomPool;
...
- (void)relaySendMessage:(TFJunYou_MessageObject*)msg relayUserId:(NSString *)relayUserId roomName:(NSString*)roomName;
