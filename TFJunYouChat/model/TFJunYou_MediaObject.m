...
@implementation TFJunYou_MediaObject
...
static TFJunYou_MediaObject *shared;

+(TFJunYou_MediaObject*)sharedInstance{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        shared=[[TFJunYou_MediaObject alloc] init];
    });
    return shared;
}
...
-(void)dealloc{
    //    NSLog(@"TFJunYou_MediaObject.dealloc");
    self.userId = nil;
    self.fileName = nil;
    self.photoPath = nil;
    self.name = nil;
...
-(void)fromDataset:(TFJunYou_MediaObject*)obj rs:(FMResultSet*)rs{
...
-(void)fromDictionary:(TFJunYou_MediaObject*)obj dict:(NSDictionary*)aDic
{
...
-(NSMutableArray*)fetch
{
    ...
    while ([rs next]) {
        TFJunYou_MediaObject *user=[[TFJunYou_MediaObject alloc] init];
