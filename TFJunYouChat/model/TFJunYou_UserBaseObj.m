//
//  TFJunYou_UserBaseObj.m
//
//  Created by Reese on 13-8-11.
//  Copyright (c) 2013年 Reese. All rights reserved.
//

#import "TFJunYou_UserBaseObj.h"
#import "FMDatabase.h"
#import "FMResultSet.h"
#import "AppDelegate.h"
#import "TFJunYou_MessageObject.h"

@implementation TFJunYou_UserBaseObj
...
static TFJunYou_UserBaseObj *sharedUser;

+(TFJunYou_UserBaseObj*)sharedInstance{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedUser=[[TFJunYou_UserBaseObj alloc]init];
    });
    return sharedUser;
}
...
-(void)dealloc{
//    NSLog(@"TFJunYou_UserBaseObj.dealloc");
    self.userId = nil;
    self.userNickname = nil;
    self.remarkName = nil;
    self.describe = nil;
...
-(void)loadFromObject:(TFJunYou_UserBaseObj*)user{
...
-(void)userFromDataset:(TFJunYou_UserBaseObj*)obj rs:(FMResultSet*)rs{
...
-(void)userFromDictionary:(TFJunYou_UserBaseObj*)obj dict:(NSDictionary*)aDic
{
    if([aDic count]<=0)
        return;
...
-(NSString*)doSendMsg:(int)aType content:(NSString*)aContent{
    ...
    [p setMsgId];
//    [p insert:nil];
    [[TFJunYou_XMPP sharedInstance] sendMessage:p roomName:nil];//发送消息
    return p.messageId;
}
