...
@implementation TFJunYou_RoomObject
...
- (void)dealloc {
//    NSLog(@"TFJunYou_RoomObject.dealloc");
    self.fullJid = nil;
    self.roomName = nil;
    self.roomTitle = nil;
    self.storage = nil;
...
//        NSArray *arr = [[TFJunYou_MessageObject sharedInstance] fetchMessageListWithUser:self.roomJid byAllNum:0 pageCount:20 startTime:[NSDate dateWithTimeIntervalSince1970:0]];
//        // 最后一条消息
//        TFJunYou_MessageObject *lastMsg = nil;
...
//    [_xmppRoom activate:[TFJunYou_XMPP sharedInstance].stream];
...
//    NSLog(@"xmppRoomDidJoin");
    ...
    //    [_xmppRoom changeToMember:self.roomJid nickName:@"tTFJunYou_"];
...
//    [x addChild:p];
//    [y addChild:x];
//    [[TFJunYou_XMPP sharedInstance].stream sendElement:y];
////    [y release];
//}
...
//
//    [[TFJunYou_XMPP sharedInstance].stream sendElement:iq];
//}
