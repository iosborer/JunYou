//
//  TFJunYou_SynchronizationTask.m
//  TFJunYouChat
//
...
@implementation TFJunYou_SynTask

static TFJunYou_SynTask *sharedUser;

+(TFJunYou_SynTask*)sharedInstance{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedUser=[[TFJunYou_SynTask alloc]init];
    });
    return sharedUser;
}
...
-(void)taskFromDataset:(TFJunYou_SynTask*)obj rs:(FMResultSet*)rs{
