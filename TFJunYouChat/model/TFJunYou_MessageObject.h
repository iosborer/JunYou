...
#define COSUMER_SERVICE_CENTER_USERID  @"10005"//在线客服
...
enum kWCMessageType {
    ...
    kWCMessageTypeCustomFace=11, //自定义的表情消息
    kWCMessageTypeEmoji=12, // 表情包中的表情消息
...
@property (nonatomic,copy) NSNumber *isVerifySignatureFailed;   // 表明是否为验签失败的消息
@property (nonatomic,strong) NSArray *  answerArr;// 问题答案列表
...
//-(void)downloadFile:(TFJunYou_ImageView*)iv;//下载文件
