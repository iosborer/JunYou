...
@interface WKWebViewViewController ()<UITextViewDelegate>
...
- (void)viewDidLoad {
    ...
    sureBtn.frame=CGRectMake(20, 20,44, 44);;
    ...
    if (_titleStr.length>0) {
       ...
       NSArray *dictArray = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"tuijianSort.plist" ofType:nil]];
        dictName =dictArray.firstObject;
      
    }else{
        NSArray *dictArray = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"tuijianUser.plist" ofType:nil]];
               dictName =dictArray.firstObject;
    }
