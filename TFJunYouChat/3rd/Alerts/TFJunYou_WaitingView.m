...
#import "TFJunYou_WaitingView.h"
#import "UIFactory.h"

@implementation TFJunYou_WaitingView
@synthesize isShowing;

static TFJunYou_WaitingView *shared;

+(TFJunYou_WaitingView*)sharedInstance{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        shared=[[TFJunYou_WaitingView alloc]initWithTitle:nil];
    });
    return shared;
}
...
//        [view release];
        ...
        CGRect r = CGRectMake(60, (TFJunYou__SCREEN_HEIGHT-200)/2, 200, 200);
