...
@implementation TFJunYou_Connection
...
//        self.httpManager.requestSerializer.timeoutInterval = TFJunYou__connect_timeout;
    }
...
-(void)dealloc{
//    NSLog(@"TFJunYou_Connection.dealloc:%@=%d",action,self.retainCount);
    self.action = nil;
    self.toView = nil;
//    self.userInfo = nil;
    self.delegate = nil;
