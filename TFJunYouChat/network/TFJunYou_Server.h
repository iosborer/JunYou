...
#define TFJunYou__page_size 12
#define TFJunYou__login_view -5100001
#define TFJunYou__connect_timeout 15
#define TFJunYou__did_yes 0
#define TFJunYou__did_no 1
#define TFJunYou__showImage_time 2.0
...
#define act_getAppResource  @"api/appResource/queryByCode"//app跳转链接
#define act_customerLinkList @"customerLink/list"//客服
#define act_getAdvertising @"advertising/queryAdvertisingOne" // 广告富文本接口

#define act_FaceList @"face/list"  //获取所有表情包
#define act_FaceGetName @"face/getName"  //获取表情包详情
#define act_FaceClollectAddFaceClollect @"faceClollect/addFaceClollect" // 收藏表情包/添加单个表情
#define act_FaceClollectDeleteByFaceName @"faceClollect/deleteByFaceName" //删除表情包
#define act_FaceClollectList @"faceClollect/list" //获取收藏的表情包列表/单个表情列表
//#define act_FaceClollectList @"face/list"
//#define act_FaceClollectAddFaceClollect @"faceClollect/addFaceClollect" //添加单个表情
#define act_FaceClollectDeleteFaceClollect @"faceClollect/deleteFaceClollect"//批量删除单个表情集合
...
#define act_apiAutoAnswergetIssue @"api/AutoAnswer/getIssue" // 自动回问题

#define act_ApiEditGetListByType @"api/edit/getListByType" // 获取常见问题 根据type

#define act_ApiEditGet @"api/edit/get" // 富文本

#define act_ApiFreezeApply @"api/Freeze/apply" // 申请冻结或解冻账号

#define act_UserCancel @"user/cancel" // 注销账号

#define act_ApiComplaintSubmit @"api/Complaint/submit" // 投诉建议&意见反馈
...
#define act_cerGetToken @"user/audit/getToken" //获取认证结果
#define act_cergetVerifyResult @"user/audit/getVerifyResult" //获取认证结果
...
#define act_payList @"pay_goods/list" //
#define act_payBuy @"pay_goods/buy" //
#define act_bizList @"biz_goods/list" //商品列表
#define act_bizBuy @"biz_goods/buy" //
...
#define act_roomJoinV1 @"room/joinV1" // 加群v1（加入了fromUserId）
...
#define act_roomMemberSetV1 @"room/member/updateV1"//设置群成员 增加fromUserId
...
#define act_userRechagrge @"user/Recharge" //
#define act_codePayment @"pay/codePayment"//
#define act_codePaymentV1 @"pay/codePayment/v1"//
#define act_payGetQrKey @"pay/getQrKey" //
#define act_payVerifyQrKey  @"pay/verifyQrKey"  //验证qrKey过期
#define act_codeReceipt @"pay/codeReceipt"//
#define act_codeReceiptV1 @"pay/codeReceipt/v1"//
#define act_receiveTransfer @"skTransfer/receiveTransfer"//
#define act_getTransferInfo @"skTransfer/getTransferInfo" //
#define act_getConsumeRecordList @"friend/consumeRecordList" //好友交易记录明细
#define act_sendTransfer @"skTransfer/sendTransfer" //
#define act_sendTransferV1 @"skTransfer/sendTransfer/v1" //
#define act_sendRedPacket @"redPacket/sendRedPacket"//
#define act_sendRedPacketV1 @"redPacket/sendRedPacket/v1"//
#define act_sendRedPacketV2 @"redPacket/sendRedPacket/v2"//
#define act_getRedPacket @"redPacket/getRedPacket"//
#define act_openRedPacket @"redPacket/openRedPacket"//
#define act_redPacketGetSendRedPacketList @"redPacket/getSendRedPacketList"//
#define act_redPacketGetRedReceiveList @"redPacket/getRedReceiveList"   //
#define act_redPacketReply @"redPacket/reply"   // 红包回复
#define act_addWithdrawl @"api/addWithdrawl"   //
#define act_withdrawlList @"api/withdrawlList"   //

#define get_NewVersion @"getNewVersion" //获取最新版本号
#define act_consumeRecord @"user/consumeRecord/list"// 
...
#define act_userCertification  @"user/certification"  // 实名认证
...
@interface TFJunYou_Server : NSObject<CLLocationManagerDelegate>{
...
-(TFJunYou_Connection*)addTask:(NSString*)action param:(NSString*)param toView:(id)toView;
...
//-(void)doError:(TFJunYou_Connection*)aDownload dict:(NSDictionary*)dict array:(NSArray*)array resultMsg:(NSString*)string errorMsg:(NSString*)errorMsg;
...
- (void)readDeleteMsg:(TFJunYou_MessageObject *)msg toView:(id)toView;//阅后即焚
...
-(void)getAppResource:(NSString *)code ToView:(id)toView; //获取APP资源
- (void)getAdvertisingToView:(id)toView; // 弹窗广告
-(void)customerLinkList:(id)toView;//获取客服链接

-(void)getFaceList:(NSString *)type View:(id)toView; //获取表情包
-(void)getFaceDetail:(NSString *)name View:(id)toView; //获取表情包详情
- (void)addFaceClollect:(NSString *)faceId faceName:(NSString *)faceName url:(NSString *)url View:(id)toView; //添加表情包 / 添加单个表情
- (void)faceClollectDeleteByFaceName:(NSString *)faceName  View:(id)toView;// 删除表情包
- (void)faceClollectListType:(NSString *)type  View:(id)toView;// act_FaceClollectList 收藏表情包列表:0 / 获取收藏的单个表情列表:1

- (void)faceClollectDeleteFaceClollect:(NSString *)ids  View:(id)toView;// act_FaceClollectDeleteFaceClollect 批量删除单个表情集合
...
@property(nonatomic,strong) TFJunYou_UserObject* myself;
@property (nonatomic, strong) TFJunYou_MultipleLogin *multipleLogin;
...
@protocol TFJunYou_ServerResult <NSObject>
