...
@property(nonatomic) float line;            
@property(nonatomic) float paragraph;   
@property(nonatomic) float MutiHeight;  
@property(nonatomic) float fristlineindent; 
@property(nonatomic) float iconSize;    
@property(nonatomic) float width;       
@property(nonatomic) int numberOfLimitLines;   
...
@property(nonatomic,readonly)float heightOflimit;   
@property(nonatomic,readonly)float miniWidth;       
@property(nonatomic,readonly)int numberOfTotalLines;         
