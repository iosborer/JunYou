...
-(void)didMoveToSuperview
{
    ...
    frame.origin.y= TFJunYou__SCREEN_HEIGHT - 100;
...
-(void)addImagesURL:(NSArray*)urls withSmallImage:(NSArray*)images
{
    ...
    for(int i=0;i<count;i++)
    {
        ...
        TFJunYou_ObjUrlData* p = [urls objectAtIndex:i];
...
-(void)setImage:(UIImage *)image
{
    ...
    self.contentOffset=CGPointMake(TFJunYou__SCREEN_WIDTH*offset, 0);
    _prePage=offset;
...
{
    self.contentOffset=CGPointMake(TFJunYou__SCREEN_WIDTH*index, 0);
    _prePage=index;
