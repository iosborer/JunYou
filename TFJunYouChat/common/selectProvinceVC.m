...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    UIView* v = [[UIView alloc]initWithFrame:CGRectMake(0, 0, TFJunYou__SCREEN_WIDTH, row_height)];
...
//        [p release];
        ...
        if([self tableView:_table numberOfRowsInSection:indexPath.section] != indexPath.row+1){
            UIView* line = [[UIView alloc] initWithFrame:CGRectMake(18,row_height-1,TFJunYou__SCREEN_WIDTH-18-20,LINE_WH)];
