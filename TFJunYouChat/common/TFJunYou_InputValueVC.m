...
@interface TFJunYou_InputValueVC ()<UITextViewDelegate>
@property (nonatomic, strong) UIView *baseView;
@property(nonatomic, assign) BOOL isShow;
@end

@implementation TFJunYou_InputValueVC
...
//        self.title = @"搜索";
        ...
        CGSize constraintSize = CGSizeMake(TFJunYou__SCREEN_WIDTH - 20, MAXFLOAT);
        CGSize size = [_name sizeThatFits:constraintSize];
        _name.frame = CGRectMake(10, 10, TFJunYou__SCREEN_WIDTH-20, size.height);
        _name.delegate = self;
        [_name resignFirstResponder];
        
        self.baseView.frame = CGRectMake(0, 15, TFJunYou__SCREEN_WIDTH, size.height+20);
...
-(void)dealloc{
//    NSLog(@"TFJunYou_InputValueVC.dealloc");
//    [super dealloc];
}
