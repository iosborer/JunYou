...
- (id)init
{
    ...
    if (self) {
        ...
        UIButton* btn;
        int h=9;h1=38;
        int w=TFJunYou__SCREEN_WIDTH-9*2;
        ...
        if(h>TFJunYou__SCREEN_HEIGHT-TFJunYou__SCREEN_TOP)
...
-(UIButton*)createButton:(int)n bkImg:(NSString*)bkImg{
    ...
    UILabel* p = [[UILabel alloc] initWithFrame:CGRectMake(8, 0, TFJunYou__SCREEN_WIDTH-9*2-8*2-20, h1)];
...
//    [p release];
    ...
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, p.frame.size.height - LINE_WH, TFJunYou__SCREEN_WIDTH, LINE_WH)];
    line.backgroundColor = HEXCOLOR(0xdcdcdc);
    [btn addSubview:line];
    
    
    UIImageView* iv = [[UIImageView alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH-9*2-5-20, 9, 20, 20)];
