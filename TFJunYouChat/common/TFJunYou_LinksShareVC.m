...
@interface TFJunYou_LinksShareVC ()
...
@implementation TFJunYou_LinksShareVC
...
- (void)viewDidLoad {
    ...
    self.bigView.frame = CGRectMake(0, TFJunYou__SCREEN_HEIGHT, TFJunYou__SCREEN_WIDTH, self.bigH);
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    [UIView animateWithDuration:.3f animations:^{
        ...
        self.bigView.frame = CGRectMake(0, TFJunYou__SCREEN_HEIGHT-self.bigH, TFJunYou__SCREEN_WIDTH, self.bigH);
    }];
}
...
- (void)setupViews {
    ...
    UILabel *title = [[UILabel alloc] initWithFrame:CGRectMake(0, 18, TFJunYou__SCREEN_WIDTH, 14)];
    ...
    CGFloat w = (TFJunYou__SCREEN_WIDTH-inset*(lineCount+1))/lineCount;// 每个宽度
...
- (void)hide {
    [UIView animateWithDuration:.3f animations:^{
        self.bigView.frame = CGRectMake(0, TFJunYou__SCREEN_HEIGHT, TFJunYou__SCREEN_WIDTH, TFJunYou__SCREEN_HEIGHT);
        self.view.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0];
