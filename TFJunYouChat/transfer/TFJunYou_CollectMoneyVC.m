...
@interface TFJunYou_CollectMoneyVC ()
...
@end
@implementation TFJunYou_CollectMoneyVC
- (void)viewDidLoad {
    [super viewDidLoad];
    self.heightHeader = 0;
    self.heightFooter = 0;
...
- (void)setupViews {
    ...
    _baseView = [[UIView alloc] initWithFrame:CGRectMake(20, TFJunYou__SCREEN_TOP+20, TFJunYou__SCREEN_WIDTH-40, TFJunYou__SCREEN_WIDTH-40)];
...
- (void)updateViews {
    ...
    _baseView.frame = CGRectMake(20, TFJunYou__SCREEN_TOP+20, TFJunYou__SCREEN_WIDTH-40, CGRectGetMaxY(_leftLabel.frame)+30);
    [self updateQr];
}
- (void)setMoneyCount {
