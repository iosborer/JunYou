...
@implementation TFJunYou_SearchShowCell
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier withNewStyle:(TFJunYou_SearchShowCellStyle)newStyle{
    ...
    if (self) {
        ...
        switch (newStyle) {
            case TFJunYou_SearchShowCellStyleUser:
                {
                    ...
                    self.aboveLable = [[UILabel alloc] initWithFrame:CGRectMake(80 ,20, TFJunYou__SCREEN_WIDTH - 90 ,22)];
                    ...
                    self.selectView = [[UIView alloc] initWithFrame:CGRectMake(8, 0, TFJunYou__SCREEN_WIDTH - 16, 60)];
                ...
                break;
            case TFJunYou_SearchShowCellStyleRecord:
                {
                    self.headImgView = [[UIImageView alloc] initWithFrame:CGRectMake(20, 9.83333, 40, 40)];
                    self.headImgView.layer.cornerRadius = 20;
                    self.headImgView.layer.masksToBounds = YES;
                    ...
                    [self.contentView addSubview:self.aboveLable];
                    self.belowLable = [[UILabel alloc] initWithFrame:CGRectMake(80 ,30, TFJunYou__SCREEN_WIDTH - 90 ,18)];
                    ...
                    [self.contentView addSubview:self.belowLable];
                    self.rightLable = [[UILabel alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH - 170 , 10 , 160 , 14.3333)];
        ...
        case TFJunYou_SearchShowCellStyleUser:
            {
                ...
                _aboveLable.frame = CGRectMake(80 ,7, TFJunYou__SCREEN_WIDTH - 90 ,22);
                _belowLable.frame = CGRectMake(80 ,35.3333, TFJunYou__SCREEN_WIDTH - 90 ,17);
            }
            break;
        case TFJunYou_SearchShowCellStyleRecord:
            {
...
- (NSAttributedString *)setContentLabelStr:(NSString *)str searchText:(NSString *)searchText{
    ...
    for (NSInteger i = 0; i < count; i ++) {
        ...
        if ([object hasSuffix:@"]"]&&[object hasPrefix:@"["]) {
            ...
            NSRange attRange = [object rangeOfString:self.searchText];
