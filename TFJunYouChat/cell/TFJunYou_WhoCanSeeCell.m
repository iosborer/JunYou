...
@implementation TFJunYou_WhoCanSeeCell
...
- (void)customView {
    ...
    _title = [[TFJunYou_Label alloc] initWithFrame:CGRectMake(60, 6, TFJunYou__SCREEN_WIDTH-60-30, 20)];
    _title.font = g_factory.font16;
    _title.backgroundColor = [UIColor clearColor];
    _title.textColor = [UIColor blackColor];
    [self.contentView addSubview:_title];

    _userNames = [[TFJunYou_Label alloc] initWithFrame:CGRectMake(60, CGRectGetMaxY(_title.frame)+6, TFJunYou__SCREEN_WIDTH-60-30, 17)];
    ...
    _editBtn = [[UIButton alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH - 40, 20, 20, 20)];
