...
@interface TFJunYou_SearchFileLogCell ()
...
@end
@implementation TFJunYou_SearchFileLogCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.sendTime = [[UILabel alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH - 200 - 15, self.headImageView.frame.origin.y, 200, self.headImageView.frame.size.height)];
        ...
        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(self.headImageView.frame) + 10, TFJunYou__SCREEN_WIDTH - 30, 80)];
...
//        self.tip.text = @"docx 464KB";
        ...
        self.line = [[UIView alloc] initWithFrame:CGRectMake(15, 149.5, TFJunYou__SCREEN_WIDTH - 15, LINE_WH)];
