...
@implementation TFJunYou_AddressBookCell
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _headImage = [[TFJunYou_ImageView alloc]init];
        ...
        _addBtn = [[UIButton alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH-70, 20, 50, 24)];
        ...
        _lineView = [[UIView alloc] initWithFrame:CGRectMake(CGRectGetMinX(_nickName.frame), 63.5, TFJunYou__SCREEN_WIDTH-CGRectGetMinX(_nickName.frame), LINE_WH)];
...
- (void)setAddressBook:(TFJunYou_AddressBook *)addressBook {
    _addressBook = addressBook;
    TFJunYou_UserObject *user = [[TFJunYou_UserObject sharedInstance] getUserById:addressBook.toUserId];
    ...
    _lineView.frame = CGRectMake(CGRectGetMinX(_nickName.frame), _lineView.frame.origin.y, TFJunYou__SCREEN_WIDTH-CGRectGetMinX(_nickName.frame), _lineView.frame.size.height);
