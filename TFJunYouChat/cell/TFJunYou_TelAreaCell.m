...
@implementation TFJunYou_TelAreaCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    if (self) {
        //国家名
        _countryName = [[UILabel alloc] initWithFrame:CGRectMake(15, 0, TFJunYou__SCREEN_WIDTH-15-15-15-50, TELAREA_CELL_HEIGHT)];
        ...
        //区号
        _areaNum = [[UILabel alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH-15-50, 0, 50, TELAREA_CELL_HEIGHT)];
        _areaNum.text = @"+1896";
        ...
        //下划线
        _bottomLine = [TFJunYou_MyTools bottomLineWithFrame:CGRectMake(15, TELAREA_CELL_HEIGHT-LINE_WH, TFJunYou__SCREEN_WIDTH-15*2, LINE_WH)];
