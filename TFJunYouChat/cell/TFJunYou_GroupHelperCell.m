...
@implementation TFJunYou_GroupHelperCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UILabel *title = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(imageView.frame) + 10, 10, TFJunYou__SCREEN_WIDTH - 65 - (CGRectGetMaxX(imageView.frame) + 10) - 10, 20)];
        title.font = [UIFont systemFontOfSize:16.0];
        [self.contentView addSubview:title];
        _title = title;
        
        
        UILabel *subTitle = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(imageView.frame) + 10, CGRectGetMaxY(title.frame) + 7, TFJunYou__SCREEN_WIDTH - 65 - (CGRectGetMaxX(imageView.frame) + 10) - 10, 20)];
        subTitle.font = [UIFont systemFontOfSize:14.0];
        subTitle.textColor = [UIColor lightGrayColor];
        [self.contentView addSubview:subTitle];
        _subTitle = subTitle;
        
        UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH - 65, 20, 50, 24)];
