//
//  TFJunYou_ShareFileTableViewCell.m
//  TFJunYouChat
//
...
@interface TFJunYou_ShareFileTableViewCell ()

@property (nonatomic, strong) MCDownloadReceipt * receipt;
@end

@implementation TFJunYou_ShareFileTableViewCell
...
-(void)setShareFile:(TFJunYou_ShareFileObject *)shareFile{
