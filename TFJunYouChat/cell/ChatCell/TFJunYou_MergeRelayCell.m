...
@implementation TFJunYou_MergeRelayCell
...
-(void)setCellData{
    ...
    for (NSInteger i = 0; i < (content.count <= 3 ? content.count : 3); i ++) {
        ...
        TFJunYou_Emoji *label = [[TFJunYou_Emoji alloc] initWithFrame:CGRectMake(10, y, kChatCellMaxWidth, 15)];
        ...
        if (self.msg.isGroup) {
            ...
            if (!self.room.showMember && [data.role intValue] != 1 && [data.role intValue] != 2) {
