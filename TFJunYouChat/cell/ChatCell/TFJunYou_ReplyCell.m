...
@interface TFJunYou_ReplyCell ()
@property (nonatomic, strong)UIView *line;

@end


@implementation TFJunYou_ReplyCell
...
-(void)creatUI{
    _replyConent = [[TFJunYou_Emoji alloc] init];
    ...
    _messageConent=[[TFJunYou_Emoji alloc] init];
...
+ (float)getChatCellHeight:(TFJunYou_MessageObject *)msg {
    ...
    float n;
    TFJunYou_Emoji *messageConent=[[TFJunYou_Emoji alloc]initWithFrame:CGRectMake(0, 0, 200, 20)];
