...
@interface TFJunYou_RoomMemberListCell()
...
@implementation TFJunYou_RoomMemberListCell
...
//    _headImageView.didTouch = @selector(headImageDidTouch);
    ...
    _lineView = [[UIView alloc] initWithFrame:CGRectMake(65, 59 - LINE_WH, TFJunYou__SCREEN_WIDTH-65, LINE_WH)];
...
- (void)setData:(memberData *)data {
    ...
    if (!self.room.showMember && [mData.role intValue] != 1 && [mData.role intValue] != 2) {
