...
@interface TFJunYou_ReadListCell ()
...
@implementation TFJunYou_ReadListCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if(self){
        ...
        _nameLable = [[UILabel alloc] initWithFrame:CGRectMake(80, 9, TFJunYou__SCREEN_WIDTH -60 - 80, 20)];
        ...
        _subLabel = [[UILabel alloc]initWithFrame:CGRectMake(80, 23, TFJunYou__SCREEN_WIDTH-60, 35)];
        ...
        _timeLabel = [[UILabel alloc]initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH - 220, 9, 200, 20)];
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 60 - LINE_WH, TFJunYou__SCREEN_WIDTH, LINE_WH)];
