...
@interface TFJunYou_CourseListCell()
...
@implementation TFJunYou_CourseListCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if(self){
        ...
        _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 10, TFJunYou__SCREEN_WIDTH -60 - 80, 20)];
        ...
        _timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(_nameLabel.frame) + 10, TFJunYou__SCREEN_WIDTH -60 - 80, 20)];
        ...
        _nextImage = [[UIImageView alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH-15-7, (70-13)/2, 7, 13)];
        _nextImage.image = [UIImage imageNamed:@"new_icon_>"];
        _nextImage.hidden = NO;
        [self.contentView addSubview:_nextImage];
        
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(15, 70 - LINE_WH, TFJunYou__SCREEN_WIDTH-15, LINE_WH)];
        line.backgroundColor = THE_LINE_COLOR;
        [self.contentView addSubview:line];
        
        _multiselectBtn = [[UIButton alloc] initWithFrame:CGRectMake(TFJunYou__SCREEN_WIDTH-20-15, 25, 20, 20)];
