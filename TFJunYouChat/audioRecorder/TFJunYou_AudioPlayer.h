...
@interface TFJunYou_AudioPlayer : NSObject<AVAudioPlayerDelegate>{
    AVAudioPlayer *_player;
    BOOL _isOpened;
    TFJunYou_WaitView* _wait;
    TFJunYou_ImageView * _voiceView;
...
@property (nonatomic, strong) TFJunYou_ImageView * voiceBtn;
