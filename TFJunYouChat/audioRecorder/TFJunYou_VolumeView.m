...
@implementation TFJunYou_VolumeView
@synthesize volume;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //椭圆下方的托架
        _volume = [[TFJunYou_ImageView alloc]initWithFrame:CGRectMake(20, 20, 120/2, 180/2)];
        _volume.image = [UIImage imageNamed:@"pub_recorder"];
        [self addSubview:_volume];
//        [_volume release];
        
//        //椭圆白色背景
//        TFJunYou_ImageView * inputBackground = [[TFJunYou_ImageView alloc]initWithFrame:CGRectMake(9, 1, 34, 66)];//20,1,66,132
...
//
//        //椭圆红色背景
//        _input = [[TFJunYou_ImageView alloc]initWithFrame:CGRectMake(-0.2, 0, 34, 70)];
