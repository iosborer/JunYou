...
@implementation TFJunYou_AudioPlayer
...
- (id)initWithParent:(UIView*)value{
    ...
    if (self) {
        ...
        _wait = [[TFJunYou_WaitView alloc] initWithParent:_parent];
    }
    return self;
}
...
- (id)initWithParent:(UIView*)value frame:(CGRect)frame isLeft:(BOOL)isLeft{
    ...
    if (self) {
        ...
        _frame = frame;
        _voiceBtn = [[TFJunYou_ImageView alloc] initWithFrame:frame];
        ...
        _voiceView = [[TFJunYou_ImageView alloc]init];
        ...
        _wait = [[TFJunYou_WaitView alloc] initWithParent:_voiceBtn];
        self.isLeft = isLeft;
    }
    return self;
}
...
- (void)dealloc {
    NSLog(@"TFJunYou_AudioPlayer.dealloc");
    self.parent = nil;
