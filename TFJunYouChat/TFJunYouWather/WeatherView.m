...
#define widthPix kScreenWidth/320+10
...
- (void)creatUI {
    ...
    _cityBt.frame = CGRectMake(80, (TFJunYou__SCREEN_HEIGHT>=812)?34:20, kScreenWidth-160, 44);
    _cityBt.tag = 10;
    ...
    for (NSInteger i = 0; i < 2; i++) {
        ...
        UILabel *dayLabel = [[UILabel alloc]initWithFrame:CGRectMake((kScreenWidth/2-140*widthPix)/2+kScreenWidth/2*i, CGRectGetMaxY(tempLabel.frame)+50, 140*widthPix, 30*heightPix)];
        dayLabel.font = [UIFont boldSystemFontOfSize:22*heightPix];
        dayLabel.textColor = [UIColor whiteColor];
        dayLabel.textAlignment = NSTextAlignmentCenter;
        dayLabel.tag = 20+i;
        [self addSubview:dayLabel];
        
        UIImageView *smallWeatherImg = [[UIImageView alloc]initWithFrame:CGRectMake((kScreenWidth/2-100*widthPix)/2+kScreenWidth/2*i, CGRectGetMaxY(dayLabel.frame), 100*widthPix, 70*heightPix)];
        smallWeatherImg.tag = 30+i;
        [self addSubview:smallWeatherImg];
        
        UILabel *samllTempLabel = [[UILabel alloc]initWithFrame:CGRectMake((kScreenWidth/2-140*widthPix)/2+kScreenWidth/2*i, CGRectGetMaxY(smallWeatherImg.frame), 140*widthPix, 30*heightPix)];
        samllTempLabel.font = [UIFont boldSystemFontOfSize:20*heightPix];
        ...
        UILabel *windLabel = [[UILabel alloc]initWithFrame:CGRectMake((kScreenWidth/2-140*widthPix)/2+kScreenWidth/2*i, CGRectGetMaxY(samllTempLabel.frame), 140*widthPix, 30*heightPix)];
        windLabel.font = [UIFont boldSystemFontOfSize:140*heightPix];
